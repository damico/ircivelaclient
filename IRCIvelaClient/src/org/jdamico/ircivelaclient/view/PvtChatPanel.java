...
public class PvtChatPanel extends JPanel {
		...
		messageArea.addKeyListener(new java.awt.event.KeyAdapter() {
			...
			private void msgKeyPressed(KeyEvent evt) {
				if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
					...
					String tempMsg = messageArea.getText().replaceAll(
							"Constants.TEACHER_IDENTIFIER",
	...
	public void sendMessage() {
		...
		String tempMsg = messageArea.getText().replaceAll(
				"Constants.TEACHER_IDENTIFIER", Constants.BLANK_STRING);
		tempMsg = messageArea.getText().replaceAll(Constants.LINE_BREAK,
				Constants.BLANK_STRING);
